const expect = require('chai').expect,
      transform = require('../entropynew.js').transform,
      validate = require('../entropynew.js').validate,
      sigma = require('../entropynew.js').sigma,
      h = require('../entropynew.js').h,
      roundFractional = require('../entropynew.js').roundFractional;
